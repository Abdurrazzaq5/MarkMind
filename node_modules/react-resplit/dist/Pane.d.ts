...
export declare type ResplitPaneProps = Omit<HTMLAttributes<HTMLDivElement>, 'onResize' | 'onResizeEnd' | 'onResizeStart'> & ResplitPaneOptions & {
    /**
 ...
 * ```
 */
export declare const ResplitPane: import("react").ForwardRefExoticComponent<Omit<HTMLAttributes<HTMLDivElement>, "onResize" | "onResizeEnd" | "onResizeStart"> & ResplitPaneOptions & {
    /**
     * The order of the pane in the layout. {@link Order}
     */
    order: Order;
